...
## Designs
Screen mockups (HTML) generated by Claude Code live in `specs/designs/`.
See [`specs/designs/README.md`](designs/README.md) for the design index.
Canonical design spec (tokens, components, pages): [`specs/designs/ui/unauth/DESIGN-SPEC.md`](designs/ui/unauth/DESIGN-SPEC.md).
